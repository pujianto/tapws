...
async def main():
    ...
    dhcp_config = DHCPConfig.From_env()
    tap = TunTapDevice(server_config.private_interface, flags=(IFF_TAP | IFF_NO_PI))
    ...
    async with Server(ServerConfig.From_env(), device=tap, dhcp_config=dhcp_config):
        await waiter
