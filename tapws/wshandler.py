...
class WebsocketHandler:
    __slots__ = ('connections', 'device', 'logger', 'is_debug', 'routes',
                 'hw_addr')
            ...
            async for message in ws:
                if message.type == web.WSMsgType.BINARY:
                    ...
                    try:
                        ...
                        self.logger.error(
                            f'Unknown error writing to device: {e}')
        ...
        for connection in self.connections:
            ...
            try:
                ...
                if dst_mac in [self.broadcast_addr, connection.mac]:
                    asyncio.create_task(
                        connection.websocket.send_bytes(message),
                        name='send').add_done_callback(
